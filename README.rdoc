...
If you are using Ruby 1.9 the only dependency to use the basic features is +active_support+.
Otherwise you will need +fastercsv+. These requirements are automatically installed for you.
